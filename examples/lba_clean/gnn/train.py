...
from atom3d.datasets import LMDBDataset, PTGDataset, NativeProtMolH5Dataset
...
def train(args, device, log_dir, rep=None, test_mode=False):
    ...
    mdh5_file = "/p/home/jusers/benassou1/juwels/hai_drug_qm/atom3d/examples/lba_md/data/MD_dataset_mapped_native.hdf5"

    train_idx = "/p/home/jusers/benassou1/juwels/hai_drug_qm/atom3d/examples/lba_md/data/mol_split/train.txt"
    ...
    train_dataset = NativeProtMolH5Dataset(qmh5_file, mdh5_file, train_idx, transform=None)
    val_dataset = NativeProtMolH5Dataset(qmh5_file, mdh5_file, val_idx, transform=None)
    test_dataset = NativeProtMolH5Dataset(qmh5_file, mdh5_file, test_idx, transform=None)
