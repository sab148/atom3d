...
from examples.smp.gnn.model import GNN_SMP
...
def train(args, device, log_dir, rep=None, test_mode=False):
    ...
    h5_file = "/p/project/hai_drug_qm/Dataset/aeneas/DB/qm.hdf5"

    train_idx = "/p/project/hai_drug_qm/Dataset/aeneas/DB/train.txt"
    val_idx = "/p/project/hai_drug_qm/Dataset/aeneas/DB/val.txt"
    test_idx = "/p/project/hai_drug_qm/Dataset/aeneas/DB/test.txt"
